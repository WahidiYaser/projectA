...
class Employee {
    ...
    //     this.typeOW = typeOW
    // }
    constructor(workH, extraWH, typeOW) {
        this.workH = workH;
        this.extraWH = extraWH;
        this.typeOW = typeOW;
    }
...
function arrOfWorkers() {
    ...
    for (let i = 0; i < leng; i++) {
        let wh = Math.round(Math.random() * (190 - 80)) + 80;
        let ewh = Math.round(Math.random() * (60 - 30)) + 30;
        let tof = Math.round(Math.random() * (2 - 1)) + 1;
